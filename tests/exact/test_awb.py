...
def test_awb_48():
    ...
    assert result['bwb_id'] == 'BWBR0005537', "should be identifier for AWB"
    assert result['number'] == '4:8', "should be article number 4:8"
...
def test_awb_32():
    ...
    assert result['bwb_id'] == 'BWBR0005537', "should be identifier for AWB"
    assert result['number'] == '3:2', "should be article number 3:2"
    assert 'book' not in result['fragment'] or result['fragment']['book'] == None, "should not have a book number"
